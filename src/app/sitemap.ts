...
const BASE_URL = 'https://junkhaulcompare.com';
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Blog posts
  const blogPosts: MetadataRoute.Sitemap = ["cheap-junk-removal-near-me", "example-post", "how-much-does-junk-removal-cost", "junk-removal-cost"].map((slug: string) => ({
